...
public class OrganizationBookmarkController {
    ...
    public OrganizationBookmarkResponse createOrganizationBookmark(
        ...
        return organizationBookmarkService.createOrganizationBookmark(organizationId, deviceId);
    }
    ...
    public void deleteOrganizationBookmark(
        ...
        organizationBookmarkService.deleteOrganizationBookmark(organizationId, deviceId);
    }
}
