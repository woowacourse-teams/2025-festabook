...
INSERT INTO event (status, start_time, end_time, title, location, event_date_id)
VALUES ('UPCOMING', '10:00:00', '11:30:00', '개막식', '운동장', 1),
       ('ONGOING', '13:00:00', '14:00:00', '동아리 공연', '야외무대', 1),
       ('ONGOING', '14:30:00', '15:30:00', '코스프레 퍼레이드', '본관 앞', 1),
       ('UPCOMING', '16:00:00', '17:00:00', '전시회 오픈', '미술관', 1),
       ('COMPLETED', '18:00:00', '19:00:00', '개발자 토크콘서트', 'IT관', 1),
       ('COMPLETED', '19:30:00', '20:30:00', '야간 영화 상영', '운동장', 1);

INSERT INTO event (status, start_time, end_time, title, location, event_date_id)
VALUES ('ONGOING', '10:00:00', '11:00:00', '오케스트라 공연', '음악홀', 2),
       ('ONGOING', '11:00:00', '12:00:00', '버스킹 공연', '중앙광장', 2),
       ('UPCOMING', '12:30:00', '13:30:00', '문학 낭독회', '도서관 앞', 2),
       ('UPCOMING', '14:00:00', '15:30:00', '먹거리 페스티벌', '푸드트럭 존', 2),
       ('COMPLETED', '16:00:00', '17:00:00', '사진전 관람', '아트센터', 2),
       ('ONGOING', '17:30:00', '18:30:00', '유튜버 팬미팅', '강의동 B103', 2),
       ('COMPLETED', '19:00:00', '20:00:00', '마술 공연', '강당', 2),
       ('UPCOMING', '20:30:00', '22:00:00', '야간 EDM 파티', '운동장', 2);

INSERT INTO event (status, start_time, end_time, title, location, event_date_id)
VALUES ('COMPLETED', '09:30:00', '10:30:00', '플리마켓', '체육관 앞', 3),
       ('UPCOMING', '11:00:00', '12:00:00', '창업 아이디어 경진대회', '창업카페', 3),
       ('ONGOING', '12:30:00', '13:30:00', '청춘 토크쇼', '대강당', 3),
       ('UPCOMING', '14:00:00', '15:00:00', '보드게임 대회', '학생회관 2층', 3),
       ('COMPLETED', '15:30:00', '16:00:00', '퀴즈쇼 결승전', '야외무대', 3),
       ('COMPLETED', '16:00:00', '17:00:00', '폐막식', '강당', 3),
       ('ONGOING', '17:30:00', '18:30:00', '무대 뒤 인터뷰', '무대 대기실', 3),
       ('UPCOMING', '19:00:00', '20:30:00', '대형 불꽃놀이', '운동장', 3),
       ('COMPLETED', '21:00:00', '22:00:00', '아티스트 엔딩 무대', '운동장', 3);
...
-- 6. 플레이스 (Place)
-- ========================
INSERT INTO place (organization_id, title, description, category, location, host, start_time, end_time)
VALUES (1, '핫도그 푸드트럭', '즉석에서 튀긴 바삭한 핫도그', 'FOOD_TRUCK', '푸드존 A', '맛있는핫도그', '10:00:00', '20:00:00'),
       (1, '타로 점 부스', '미래가 궁금한 당신을 위한 점괘 부스', 'BOOTH', '부스 B-2', '타로동아리', '10:00:00', '20:00:00'),
       (1, '수공예 마켓', '학생들의 수공예 작품 전시 및 판매', 'BOOTH', '부스 A-1', '수공예동아리', '10:00:00', '20:00:00'),
       (1, '야외 바', '시원한 음료와 간단한 안주 제공', 'BAR', '푸드존 B', '칵테일클럽', '10:00:00', '20:00:00'),
       (1, '사진 스튜디오', '기념 촬영 부스', 'BOOTH', '포토존', '사진부', '10:00:00', '20:00:00'),
       (1, '빙수 푸드트럭', '시원한 과일 빙수 판매', 'FOOD_TRUCK', '푸드존 C', '빙수친구들', '10:00:00', '20:00:00'),
       (1, '페이스 페인팅', '얼굴에 그림 그려주는 체험 부스', 'BOOTH', '체험존 A', '미술동아리', '10:00:00', '20:00:00'),
       (1, 'VR 게임존', 'VR 체험 부스', 'BOOTH', '체험존 B', '게임동아리', '10:00:00', '20:00:00');
