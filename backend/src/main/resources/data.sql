...
VALUES ('페스타북 축제에 오신 것을 환영합니다!', '3일간의 즐거움을 함께하세요!', true, 1, '2025-07-16 10:00:00'),
       ('중요: 축제 입장 규칙 안내', '모든 참가자는 QR코드가 포함된 티켓을 지참해주세요.', true, 1, '2025-07-17 09:00:00'),
...
-- 자주 묻는 질문 (Question)
-- ========================
INSERT INTO question (organization_id, question, answer, created_at, sequence)
VALUES (1, '차를 가져가도 될까요?', '동문 주차장을 이용하실 수 있습니다.', '2025-07-16 09:30:00', 1),
       (1, '부스 위치가 궁금해요.', '푸드트럭은 운동장 오른쪽 라인에 위치합니다.', '2025-07-16 09:40:00', 2);
