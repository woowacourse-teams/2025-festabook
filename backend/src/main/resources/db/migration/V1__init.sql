...
ALTER TABLE council
    ADD CONSTRAINT uc_council_username UNIQUE (username);

ALTER TABLE announcement
    ADD CONSTRAINT FK_ANNOUNCEMENT_ON_FESTIVAL FOREIGN KEY (festival_id) REFERENCES festival (id);

ALTER TABLE council
    ADD CONSTRAINT FK_COUNCIL_ON_FESTIVAL FOREIGN KEY (festival_id) REFERENCES festival (id);
...
ALTER TABLE lineup
    ADD CONSTRAINT FK_LINEUP_ON_FESTIVAL FOREIGN KEY (festival_id) REFERENCES festival (id);
...
ALTER TABLE council_roles
    ADD CONSTRAINT fk_council_roles_on_council FOREIGN KEY (council_id) REFERENCES council (id);
